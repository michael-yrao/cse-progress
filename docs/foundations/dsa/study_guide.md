...
* **Comfort bar is the same**: Easy does not lower the standard. Both problems must be completable from a blank page, no hints, to log 🟢 Clean (the rating ignores Big-O — see `spaced-repetition.md`).
