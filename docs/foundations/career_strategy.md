...
[`system_design/senior_ramp.md`](system_design/senior_ramp.md).
...
| **Big tech / MANGA** ⭐ | Google, Amazon, Meta, Microsoft, Apple, Netflix | **THE END GOAL** | Where the hops above lead. The plan optimizes for **here**; SD readiness driven by [`senior_ramp.md`](system_design/senior_ramp.md), gated not dated |
...
- **Gate 3 — big tech / end goal.** The [`senior_ramp.md`](system_design/senior_ramp.md) **Phase-C apply
