...
| Pillar | Owner | Where |
|---|---|---|
| **Delivery** — the six steps and their time budgets | shared: learner studies it, coach times the mock against it | [`framework.md`](https://github.com/michael-yrao/sd-progress/blob/main/framework.md) *is* HelloInterview's Delivery, step for step |
