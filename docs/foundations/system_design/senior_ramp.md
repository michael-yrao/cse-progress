...
[`career_strategy.md`](https://github.com/michael-yrao/cse-progress/blob/main/docs/foundations/career_strategy.md) §4 Gate 3, which also requires DSA in maintenance:
