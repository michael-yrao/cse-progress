...
**How to apply:** Only use Read on `.py` files under `dsa/`. Explanations, bug findings, and suggestions are fine — but do not apply fixes. Offer fixes as text the user can type themselves. Editing docs, schedules, and `dsa_progress.md` is fine.
