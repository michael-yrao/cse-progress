...
- [Execution workflow](feedback_execution_workflow.md) — gamification/site-integration work: Opus plans, Sonnet 5 subagent implements (no commit/push), Opus reviews + runs `advisor` before any commit/push.
