---
name: feedback_coding_for_clean
...
**How to apply:** If the user reports "Clean" on a session they only blueprinted (no code), record 🟡 Shaky and say why in one kind sentence — unless the problem is already 🎓 Graduated and the blueprint was flawless (then confirm 🎓). Relates to [[feedback_whiteboard_fidelity]] and [[feedback_no_code_edits]].
